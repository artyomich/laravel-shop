...
<div class="row">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-center">
                        ...
                        @if ($product->balance && $product->is_visible)
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                                <div class="price">
                                    ...
                                    <span> = </span>
                                    <span class="product-total-cost m-t-2">{{ $product->balance->cost * 4 }}</span>
                            ...
                            <div class="message">
                                <span id="notEnough" style="display: none">На складе не достаточно шин.<br>Пожалуйста, уточняйте сроки их поставки у менеджера.</span>
                            </div>
                        @else
                            <link itemprop="availability" href="http://schema.org/OutOfStock"/>
                            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-5">
                                <div>
                                      <span class="m-t-2" itemprop="price"
                                            content="{{ $product->balances[0]->cost }}">{{ $product->balances[0]->cost }}</span>
                                    <span itemprop="priceCurrency" content="RUB" class="rur">a</span>
                                </div>
                                <div class="m-t-4">нет в наличии</div>
                            </div>
                            <div class="buy col-xs-12 col-sm-4 col-md-4 col-lg-7">
                                {{ \widgets\modals\NotifyProductsModal::a(['product_id' => $product->id]) }}
                            </div>
                        @endif
                    </div>
                    ...
                    @if (strtolower($product->properties->brand) === 'nortec')
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                            <a href="/files/nortec_small.pdf" target="_blank" class="thumbnail">Каталог продукции
                                Nortec</a>
                        </div>

                    @elseif (strtolower($product->properties->brand) === 'forward')
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                            {{ \widgets\modals\ForwardAdModal::a(['class' => 'thumbnail videoLink']) }}
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                            <a href="/files/ashk_small.pdf" target="_blank" class="thumbnail">Каталог продукции АШК</a>
                        </div>
                    @elseif (strtolower($product->properties->brand) === 'АЛТАЙШИНА')
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                            <a href="/files/ashk_small.pdf" target="_blank" class="thumbnail">Каталог продукции АШК</a>
                        </div>
                    @endif
                ...
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 m-t-12">
                    @if ($product->balance)
                        <div>
                        ...
                        @if (count ($sizes))
                            <div class="types">Другие типоразмеры автошины {{ $product->name_short }}:</div>
                            <div>
                                <table class="table table-condensed table-striped table-properties table-hover">
                                    <tbody>
    ...
    {{ \modules\main\widgets\ProductInstructions::widget(['product' => $product, 'pageAlias'=>"kak-kupit'"]); }}
</div>
<!-- /CONTENT -->
