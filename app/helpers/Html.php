...
class Html
{
    ...
    public static function radio($name, $checked = false, $options = [])
    {
        ...
        if (isset($options['label'])) {
            ...
            $content = static::label(
                static::input('radio', $name, $value, $options) . ' ' . $label, null, $labelOptions
            );
    ...
    public static function checkbox($name, $checked = false, $options = [])
    {
        ...
        if (isset($options['label'])) {
            ...
            unset($options['label'], $options['labelOptions'], $options['container']);
            $content = static::label(
                static::input('checkbox', $name, $value, $options) . ' ' . $label, null, $labelOptions
            );
            if (is_array($container)) {
                return $hidden . static::tag('div', $content, $container);
            } else {
     ...
     *
     * @param ActiveRecord|ActiveRecord[] $models  the model(s) whose validation errors are to be displayed
     * @param array                       $options the tag options in terms of name-value pairs. The following options are specially handled:
     *
    ...
    public static function renderSelectOptions($selection, $items, &$tagOptions = [])
    {
        ...
        if (isset($tagOptions['prompt'])) {
            $prompt = $encodeSpaces ? str_replace(' ', '&nbsp;', static::encode($tagOptions['prompt']))
